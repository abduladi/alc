...
subprocess.call('curl https://fastdl.mongodb.org/linux/mongodb-linux-x86_64-amazon-3.6.2.tgz --output mongodb.tgz', shell=True)

print 'Unzipping binary files'
subprocess.call('tar -zxvf mongodb.tgz', shell=True)

subprocess.call('./mongodb-linux-x86_64-3.6.2/bin/mongod')
